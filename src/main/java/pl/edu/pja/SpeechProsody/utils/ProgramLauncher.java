...
public class ProgramLauncher implements Runnable {
    ...
    final Logger logger = LoggerFactory.getLogger(ProgramLauncher.class);
    ...
    private InputStream istr = System.in;
    ...
    public void setStdinStream(InputStream istr) {
        this.istr = istr;
    }
    ...
    public void run() {
        ...
        try {
            if (!suppressOutput) {
                PumpStreamHandler stream = new PumpStreamHandler(ostr, estr, istr);
